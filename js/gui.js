...
var Gui = function() {
	...
	this.createImageCellLoops = function() {
		...
		dogLoop.addFrame(new ImageCell(this.rawImageRepository.getRawImages()[1], 1, 21, 15, 11, 0, 0), 250);
		dogLoop.addFrame(new ImageCell(this.rawImageRepository.getRawImages()[1], 17, 21, 14, 11, 0, 0), 250);
		dogLoop.addFrame(new ImageCell(this.rawImageRepository.getRawImages()[1], 33, 21, 15, 11, 0, 0), 250);
		//
